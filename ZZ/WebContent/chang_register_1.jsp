...
如注册遇到问题请拨打：<strong style="font-size:14px;">400-080-6699</strong></div>
 ...
 <section class="main w12">
   <div class="title"><a class="title1 db fl">厂家注册</a><a href="ke_register_1.jsp" class="title2 db fl">客户注册</a></div>
   <div class="fr tit2"><span class="arr"></span></div>
   <div class="w12 step1"></div>
   <div class="inputsec">
     <form name="myform" action="companyregisteraction" method="post">
     <ul>
	   ...
	   <input class="db fl next" type="submit" value="下一步" onclick="return check_phone();" onMouseOver="this.style.background='#27c42d'" onMouseOut="this.style.background='#19861d'"/>
     </ul>
	 </form>
   </div>
 </section>
