...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="720" valign="top"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
      <tr>
        <td width="71%" align="left" class="font_14 xuxian"><strong>木家具 </strong></td>
      </tr>
    </table>
            ...
            <c:forEach items="${cglists}" var="a" >
			             <form action="" name="myform" id="">
						   <tr >
               				     ...
               				     <td align="center"><a href="login.jsp" style="border: 2ex;font-size: 20px;color: orange;">购买</a></td>
               				</tr>
               				</form>
