    ...
    <td width="280" valign="top"><table width="260" border="0" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr valign="top" class="hg_30">
        <td align="left"><table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
            ...
            <tr>
              <td align="left" class="xuxian" style="padding-left:30px;"><a href="companyGoodsaction1" >·木家具
              </a></td>
              </tr>
            <tr>
              <td align="left" class="xuxian" style="padding-left:30px;"><a href="companyGoodsaction2" >·金属家具 </a></td>
            </tr>
            <tr>
              <td align="left" class="xuxian" style="padding-left:30px;"><a href="companyGoodsaction3" >·软体家具 </a></td>
            </tr>
            <tr>
              <td align="left" class="xuxian" style="padding-left:30px;"><a href="companyGoodsaction4" >·钢木家具 </a></td>
            </tr>
            <tr>
              <td align="left" class="xuxian" style="padding-left:30px;"><a href="companyGoodsaction5" >·竹家具</a></td>
            </tr>
