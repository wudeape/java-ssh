...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="280" valign="top"><table width="260" border="0" align="left" cellpadding="0" cellspacing="0">
     ...
     <tr valign="top" class="hg_30">
        <td align="left"><table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
            ...
            <tr>
              <td align="left" class="xuxian" style="padding-left:30px;"><a href="newsite.jsp" target="_blank">·木家具
              </a></td>
              </tr>
            <tr>
              <td align="left" class="xuxian" style="padding-left:30px;"><a href="newsite.jsp" target="_blank">·金属家具 </a></td>
            </tr>
            <tr>
              <td align="left" class="xuxian" style="padding-left:30px;"><a href="newsite.jsp" target="_blank">·软体家具 </a></td>
            </tr>
            <tr>
              <td align="left" class="xuxian" style="padding-left:30px;"><a href="newsite.jsp" target="_blank">·钢木家具 </a></td>
            </tr>
            <tr>
              <td align="left" class="xuxian" style="padding-left:30px;"><a href="newsite.jsp" target="_blank">·竹家具</a></td>
            </tr>
    ...
    <td width="720" valign="top"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
      <tr>
        <td width="71%" align="left" class="font_14 xuxian"><strong>EB-6100CC镀铬系列</strong></td>
      </tr>
    </table>
        <table width="100%" border="0" cellpadding="0" cellspacing="20" class="hg_30">
          <tr valign="top">
            <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="54%"><img src="images/log3.png" width="364" height="364" border="0" /></td>
                <td width="46%" align="center" valign="top"><table border="0" align="center" cellpadding="0" cellspacing="0" class="hg_30">
                  <tr>
                    <td class="font_14"><strong>单孔洗脸盆用水龙头</strong></td>
                  </tr>
                  <tr>
                    <td>型　　号：DL349-1E<br />
                      商品名称：单孔单柄洗脸盆用混合水龙头<br />
                      进水要求：0.05MPa(动压)~0.75MPa(静压)<br />
                      吐 水 口：带起泡器<br />
                      排水配件：已配</td>
                  </tr>
                  <tr>
              ...
              <tr>
                <td colspan="2">电镀外表加上特有的精密加工技术，营造出绝佳的镜面效果。<br />
                  简洁的手柄具有极佳的易操作性，水龙头涌出的带泡沫水流会画出一道美丽的流线，不会有一滴水溅出。<br />
                  陶瓷阀芯，经久耐用。<br />
                泡沫吐水，节水环保。</td>
              </tr>
            </table></td>
