        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="20" class="hg_30">
          <tr valign="top">
            <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr>
                  <td align="center">盈宝卫浴   2013-11-11</td>
                </tr>
                <tr>
                  <td align="left">　　公司会对每一名新员工进行一天的入职培训。<br />
                    这个培训向新员工介绍谱非晨的理念、业务发展、女鞋基础知识、发展历史以及人才培养观念，进而使他们很快融入到谱非晨（PERFECTION）这个大家庭之中。<br />
                    这个培训旨在激励新员工，培养员工对企业的认同感树立积极良好的工作态度。</td>
                </tr>
                <tr>
                  <td align="left"><img src="images/03.png" width="670" height="306" /></td>
                </tr>
            </table></td>
          </tr>
      </table></td>
