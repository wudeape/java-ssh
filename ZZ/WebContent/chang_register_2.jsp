...
如注册遇到问题请拨打：<strong style="font-size:14px;">400-080-6699</strong></div>
 ...
 <section class="main w12">
   ...
   <div class="inputsec">
   <form action="companyregisteraction2" method="post">
     <ul>
       ...
       <li class="clr"><label class="db fl">&nbsp;</label><input class="db fl next" type="submit" value="下一步" onclick="return check_password();" onMouseOver="this.style.background='#27c42d'" onMouseOut="this.style.background='#19861d'"/></li>
     </ul>
	 </form>
   </div>
 </section>
